...
try:
    ...
    Qgis.ngqVersion = staticmethod(Qgis.ngqVersion)
    Qgis.ngqVersionInt = staticmethod(Qgis.ngqVersionInt)
    Qgis.ngqIsNightlyBuild = staticmethod(Qgis.ngqIsNightlyBuild)
    Qgis.ngqChannel = staticmethod(Qgis.ngqChannel)
    Qgis.ngqChannelName = staticmethod(Qgis.ngqChannelName)
    Qgis.ngqFullVersion = staticmethod(Qgis.ngqFullVersion)
