...
QgsAuthNextGISMethod::QgsAuthNextGISMethod()
{
  ...
  setDataProviders( QStringList() << QStringLiteral( "wfs" ) // convert to lowercase
                                  << QStringLiteral( "wms" ) << QStringLiteral( "ogr" ) << QStringLiteral( "gdal" ) );
}
...
bool QgsAuthNextGISMethod::updateNetworkRequest( QNetworkRequest &request, const QString &authcfg, const QString &dataprovider )
{
